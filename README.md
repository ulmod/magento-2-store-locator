...
[Magento 2 Store Locator](https://www.ulmod.com/magento-2-store-locator-extension.html) is a Magento 2 extension that allows your shoppers to easily find the nearest physical stores with the products they need.

With Magento 2 Store Locator, you can create an unlimited number of store locations and display them on an SEO-optimized and user-friendly store locator page.

<a href="https://www.ulmod.com/magento-2-store-locator-extension.html"><img width="205" src="https://www.ulmod.com/media/wysiwyg/um-download-now1.png"></a>

## Key Features

* Create any number of store locations
* Allows shoppers to search stores by address, country, state, zip code, and more
...
* Ability expand and collapse the opening and closing hours
* Support multi-stores
* Ability to import locations via a CSV file. Sample import file supported
* Mobile-friendly
